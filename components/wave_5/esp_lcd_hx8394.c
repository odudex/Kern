...
static esp_err_t panel_hx8394_invert_color(esp_lcd_panel_t *panel,
...
esp_lcd_new_panel_hx8394(const esp_lcd_panel_io_handle_t io,
  ...
  hx8394_vendor_config_t *vendor_config =
      (hx8394_vendor_config_t *)panel_dev_config->vendor_config;
...
static esp_err_t panel_hx8394_invert_color(esp_lcd_panel_t *panel,
                                           bool invert_color_data) {
  hx8394_panel_t *hx8394 = (hx8394_panel_t *)panel->user_data;
  ESP_RETURN_ON_FALSE(hx8394->io, ESP_ERR_INVALID_STATE, TAG,
                      "invalid panel IO");
