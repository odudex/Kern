...
key_get_fingerprint(unsigned char *fingerprint_out);
...
KERN_WARN_UNUSED_RESULT bool key_get_xpub_components(const uint32_t *path,
                                                     size_t path_depth,
                                                     char **xpub_out);
...
KERN_WARN_UNUSED_RESULT bool key_get_mnemonic(char **mnemonic_out);
 ...
 * free() the array. */
KERN_WARN_UNUSED_RESULT bool key_get_mnemonic_words(char ***words_out,
...
KERN_WARN_UNUSED_RESULT bool key_get_derived_key(const char *path,
