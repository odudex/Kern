...
miniscript_policy_is_miniscript(const struct wally_descriptor *desc);
...
miniscript_policy_string(const struct wally_descriptor *desc);
...
KERN_WARN_UNUSED_RESULT char *miniscript_policy_indent(const char *expr,
...
KERN_WARN_UNUSED_RESULT bool
miniscript_policy_view_build(const char *policy, size_t max_line_width,
