...
KERN_WARN_UNUSED_RESULT bool script_template_from_pubkey(
    script_template_type_t type, const uint8_t *pubkey, size_t pubkey_len,
    uint8_t *spk_out, size_t *spk_len, uint8_t *redeem_out, size_t *redeem_len);

KERN_WARN_UNUSED_RESULT bool
script_template_pubkey_matches_spk(const uint8_t *pubkey, size_t pubkey_len,
                                   const uint8_t *target_spk,
                                   size_t target_spk_len);

KERN_WARN_UNUSED_RESULT char *
script_template_address_from_spk(const unsigned char *script, size_t script_len,
                                 bool is_testnet);
